...
public class AdapterBuku extends RecyclerView.Adapter<AdapterBuku.ViewAdapter>{
    ...
    public AdapterBuku(Context context, List<Buku> list){
    ...
    public void onBindViewHolder(@NonNull ViewAdapter holder, int position) {
        holder.judulBuku.setText(list.get(position).judulBuku);
        holder.namaPenulis.setText(list.get(position).namaPenulis);
        holder.jumlahHalaman.setText(list.get(position).jumlahHalaman);
    }
